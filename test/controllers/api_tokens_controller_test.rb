...
class ApiTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_token" do
    assert_difference("ApiToken.count") do
      post api_tokens_url, params: {api_token: attributes_for(:api_token)}
    end
    assert_redirected_to api_token_url(ApiToken.order(created_at: :asc).last)
  end
  ...
  test "should update api_token" do
    patch api_token_url(@api_token), params: {api_token: attributes_for(:api_token)}
